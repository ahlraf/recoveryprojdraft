...
class _MoodChartState extends State<MoodChart> {
  ...
  void initState() {
    ...
    Provider.of<MoodCard>(context, listen: false).data.forEach((element) {
      if (element.moodNumber == 1)
        a = a + 1;
      else if (element.moodNumber == 2)
        b = b + 1;
      else if (element.moodNumber == 3)
        c = c + 1;
      else if (element.moodNumber == 4)
        d = d + 1;
      else if (element.moodNumber == 5)
        e = e + 1;
      else
        f = f + 1;
    });
    ...
    Provider.of<MoodCard>(context, listen: false)
      ...
      if (element == 'Sports')
        ...
        h = h + 1;
      else if (element == 'Shopping')
        i = i + 1;
      else if (element == 'Relaxation')
        j = j + 1;
        ...
        r = r + 1;
      else if (element == 'Cleaning') s = s + 1;
    });
  ...
  Widget build(BuildContext context) {
    ...
    List<charts.Series<MoodData, String>> series = [
      charts.Series(
        ...
        measureFn: (MoodData series, _) => series.moodNumber,
