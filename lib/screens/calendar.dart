...
final Map<DateTime, List> _holidays = {
  ...
  DateTime(2021, 12, 31): ['New Year\'s Eve'],
};

void main() {
  initializeDateFormatting().then((_) => runApp(SecondRoute()));
}
        ...
        body: SafeArea(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/finalmaybe.png'),
              fit: BoxFit.cover,
            ),
          ),
          child: Center(
            child: FlatButton(
              ...
              child: Text('Open to track progress',
                  style: TextStyle(
